<!-- USPEŠNO PRIJAVLJEN ADMIN --->
<!-- USPEŠNO DODAJ/DELETE/POSODOBI ARTIKEL 'OB PRAVILNEM IZTEKU VAS PREUSMERI SEM' --->
...
<div class="home-main-iskanje-item1">
  <input  id="iskanje" type="text" name="iskanje" value="" placeholder="Iskanje..." style="width:fit-content;">
  <br>
</div>

<div class="home-main-iskanje-gumb" >
  <input type="submit" name="submit" value="Išči" />
</div>
</div>

<div class="home-main-page">
<div class="home-main-page-filtri" style="background-color:#E6B0AA">
...
<select name="cena" id="cena" style="font-size:15px">
    <option value="Najnizja"><h6>Naraščajoče</h6></option>
    <option value="Najdrazja"><h6>Padajoče</h6></option>
</select>
<br><br>
...
if (isset($_POST['filtri'])) {
    ...
    if ($result_filtri!=null) {
        ...
        while ($row = $result_filtri->fetch_assoc()) {
            ...
            <h4>
            <a href="./izdelek_admin.php?artikel=<?php echo $row['artikel']?>"><?php echo $row['artikel']?></a>
            </h4>
